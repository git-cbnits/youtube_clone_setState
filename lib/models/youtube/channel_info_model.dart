...
ChannelInfo channelInfoFromJson(String str) => ChannelInfo.fromJson(json.decode(str));String channelInfoToJson(ChannelInfo data) => json.encode(data.toJson());
...
class ContentDetails {
  ...
  factory ContentDetails.fromJson(Map<String, dynamic> json) => ContentDetails(
    relatedPlaylists: RelatedPlaylists.fromJson(json["relatedPlaylists"]??RelatedPlaylists(likes: '', favorites: '', uploads: '', watchHistory: '', watchLater: '')),
  );
