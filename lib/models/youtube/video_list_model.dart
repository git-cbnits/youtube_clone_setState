...
VideosList videosListFromJson(String str) => VideosList.fromJson(json.decode(str));String videosListToJson(VideosList data) => json.encode(data.toJson());
...
class Thumbnails {
  ...
  factory Thumbnails.fromJson(Map<String, dynamic> json) => Thumbnails(
    ...
    standard: json["standard"]!=null? Default.fromJson(json["standard"]): Default(height: 0,url: '',width: 0),
    maxres: json["maxres"]!=null ? Default.fromJson(json["standard"]): Default(height: 0,url: '',width: 0),
  );
